...
# 2 by 3 matrix from the vectors. You'll need to figure out which of 
...
# Ex 8: Ok time for our last exercise! Find out how to use 
# runif() to create a 4 by 5 matrix consisting of 20 random numbers (4*5=20).
set.seed(42)
sample <- runif(20)
m3 <- matrix(sample, nrow = 4, ncol=5)
m3
